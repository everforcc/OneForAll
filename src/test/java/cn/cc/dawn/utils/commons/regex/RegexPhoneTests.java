 ...
 * 手机号相关正则
 */
public class RegexPhoneTests {

    @Test
    public void tPhone() {
        String pattern = "^(13[0-9]|14[5,9]|15[^4]|16[5,6]|17[0-9]|18[0-9]|19[1,8,9])\\d{8}$";
        String p1 = "11111111111";
        String p2 = "19112345678";
        System.out.println(RegexUtils.isMatches(pattern, p1));
        System.out.println(RegexUtils.isMatches(pattern, p2));
    }
