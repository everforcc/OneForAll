...
//
//        AppCache customerUser = appConfigurationCache.getCustomerUser();
//
...
//                // 设置指定类型key的参数
//                .withCacheConfiguration(customerUser.getCachekey(), RedisCacheConfiguration.defaultCacheConfig()
//                                .entryTtl(customerUser.getExpired()) // 设置过期时间
