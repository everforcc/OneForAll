...
public class HttpUrlConnectImpl implements HttpMethod {
    ...
    private static InputStream getStreamFlow(HttpParam httpParam) throws IOException {
    ...
    private static String bufferReaderToStr(InputStream inputStream, String charSet, boolean gzip)throws Exception {
//        if(gzip){
